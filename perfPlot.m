...
plotDrawStyle10={   struct('color',[1,0,0],'lineStyle','-'),...%r
    struct('color',[0,1,0],'lineStyle','--'),...%g
    struct('color',[0,0,1],'lineStyle',':'),...%b
    struct('color',[0,0,0],'lineStyle','-'),...%    struct('color',[1,1,0],'lineStyle','-'),...%yellow
    struct('color',[1,0,1],'lineStyle','--'),...%pink
    struct('color',[0,1,1],'lineStyle',':'),...
    struct('color',[0.5,0.5,0.5],'lineStyle','-'),...%gray-25%
...
seqs = configSeqs50; % fishSeqs ;boatSeqs
% seqs = seqs([2:11]);
...
rankNum = 10;%number of plots to show 10
...
% rankingType = 'AUC';%AUC, threshold
% 
% rankNum = 20;%number of plots to show 10
