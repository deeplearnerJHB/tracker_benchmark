...
pathRes = 'F:\caffe-master\tracker_benchmark_v1.0\results\results_OPE_CVPR13\';%results_OPE_CVPR13\';% The folder containing the tracking results
pathDraw = 'F:\caffe-master\tracker_benchmark_v1.0\tmp\imgs\rd3_cmp\';% The folder that will stores the images with overlaid bounding box
...
seqs = configSeqs100;%configSeqs2015;
% seqs = seqs([50]);
